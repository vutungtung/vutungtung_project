...
const Booking = () => {
  ...
  return (
    <>
      {/* Header Section */}
      <div className="bg-new-top w-full py-10 px-4 sm:px-6 lg:px-20 text-white text-center">
      ...
      <div className="bg-white w-full max-w-[1290px] mx-auto  px-4 sm:px-6 lg:px-8 my-10">
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="flex-1 space-y-6">
            {/* Vehicle Selection */}
            <div className="border border-new-end rounded p-6 shadow-sm">
              <h2 className="text-base sm:text-lg font-semibold mb-4">
                🚗 Vehicle Selection
              </h2>
              <select
                className="w-full border border-new-end rounded px-3 py-2"
            ...
            <div className="border border-new-end rounded p-6 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select className="w-full border border-new-end rounded px-3 py-2">
            ...
            <div className="border border-new-end rounded p-6 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input
                  ...
                  className="border border-new-end rounded px-3 py-2"
                />
                <input
                ...
                <input
                  ...
                  className="border border-new-end rounded px-3 py-2 md:col-span-2"
                />
                <textarea
          ...
          {/* Booking Summary */}
          <div className="w-full lg:w-[350px] border h-fit border-new-end rounded p-4 sm:p-6 shadow-sm space-y-5">
            <h2 className="text-lg font-semibold border-b border-new-end pb-2">
              Booking Summary
            </h2>
            {selectedVehicle ? (
              <div className="space-y-4 text-sm text-[var(--color-text)]">
                <div className="space-y-1 border-b border-new-end pb-3">
                  <p>
                ...
                <div className="flex justify-between items-center border-b border-new-end pb-3">
