...
//     const matchTransmission =
//       filters.transmission === "" ||
//       vehicle.transmission === filters.transmission.toUpperCase();
//     const matchFuel =
//       filters.fuelType === "" ||
//       vehicle.fuelType === filters.fuelType.toUpperCase();
//     const matchPrice =
//       filters.pricePerDay === "" ||
//       (() => {
//         const [minStr, maxStr] = filters.pricePerDay
...
//         const max = parseInt(maxStr);
//         return (
//           parseInt(vehicle.dailyRate) >= min &&
//           parseInt(vehicle.dailyRate) <= max
//         );
//       })();
...
//               pricePerDay={parseInt(vehicle.dailyRate)}
//             />
//           ))
//         )}
//       </div>
