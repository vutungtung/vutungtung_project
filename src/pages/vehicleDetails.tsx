...
//       licenseNumber,
//       locationData: { pickupLocation, returnLocation },
//       pickupDate,
//       returnDate,
//     };

//     const bookingParams = encodeURIComponent(JSON.stringify(bookingData));
//     navigate(`/confirm-booking/${bookingParams}`);
//   };
//   useEffect(() => {
...
//   const totalPrice =
//     (days > 0 ? days : 0) * (vehicle.pricePerDay + INSURANCE_PER_DAY) +
//     SERVICE_FEE;
...
//                 ...locationData,
//                 ...data,
//                 pickupDate: data.pickupDate || getTomorrowDate(),
//                 returnDate: data.returnDate || getTomorrowDate(),
//               })
//             }
...
//               <label
//                 htmlFor="licenseUpload"
//                 className="flex flex-col items-center justify-center w-full cursor-pointer transition"
//               >
//                 <LuCloudUpload className="w-10 h-10 text-gray-400 mb-2" />
//                 <p className="text-blue-600 font-medium">
//                   {licenseFile ? licenseFile.name : "Upload a file"}
...
//               <div className="flex justify-between">
//                 <span>Insurance (self-drive)</span>
//                 <span>${INSURANCE_PER_DAY * days}</span>
//               </div>
//               <div className="flex justify-between font-bold text-lg border-t pt-2">
//                 <span>Total</span>
