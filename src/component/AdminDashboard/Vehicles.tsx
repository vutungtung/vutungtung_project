...
//     const matchesCategory =
//       filterCategory === "All" || v.category.name === filterCategory;
...
//         `http://localhost:4000/api/vehicles/delete/${id}`,
//         {
//           method: "DELETE",
//         }
//       );
...
//                       }`}
//                     >
//                       {v.status} {/* Or format it for display */}
//                     </p>
//                   </div>
//                 </div>
...
//       <DeleteVehicleModal
//         vehicleTitle={deleteVehicleTarget?.title || "Unknown Vehicle"}
//         onClose={() => setDeleteVehicleTarget(null)}
//         onConfirm={() =>
//           deleteVehicleTarget?.id && handleDelete(deleteVehicleTarget.id)
//         }
//       />
//     </div>
//   );
