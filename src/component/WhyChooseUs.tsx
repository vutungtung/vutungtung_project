  ...
  return (
    <div className="mt-15 mb-15 max-w-[1290px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center">
      <div className="w-full max-w-3xl ">
        <h1 className="text-2xl sm:text-3xl text-center mb-15 md:text-4xl font-main font-bold leading-tight md:leading-snug">
          Flexible rentals, unbeatable prices—explore the city your way!
        </h1>
      </div>
